...
using AccountingTransactionService.Core.Configuration;
...
namespace AccountingTransactionService.Types
{
    ...
    class PaymentAccountingTransactionHelper : IAccountSearch
    {
        ...
        public string GetTarget(AccountingTransactionTemplateDetail template)
        {
            bool conditionExpr = template.DocumentType == DocumentType.PaymentOrder && 
                                 ...
                                 //payment.OperatorRecipient != null 
    ...
    class AccountingTransactionDetailCollection : List<AccountingTransactionDetail>
    {
    }
}
